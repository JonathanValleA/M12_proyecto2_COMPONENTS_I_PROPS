...
// Se importa el componente ejercicio2
function ejercicio2() {
    // Se retorna una vista con dos componentes User y Input
    return (
        <div className='App'>
...
// Exportamos la funcion ejercicio2 para usarlaen otro lugar de nuestra Aplicacion.
